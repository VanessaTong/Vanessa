...
public enum Capability {
	...
	FORCE_TRAIN, // FORCE_TRAIN capability allows an entity to ForceTrain another entity
				// with the ForceTrain Affordance	
	ABDUCTOR, //ABDUCTOR capability allows an entity to abduct another entity into a subgrid.
			  // Any ABDUCTOR entity MUST implement the SubGridContainer interface.
}
