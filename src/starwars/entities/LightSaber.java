 ...
 * 
 * LightSaber requires a Force ability of at least 2 in order to be wielded as a weapon.
 * 
 *  @author Robert
 *  @see {@link starwars.actions.Attack}
 */

public class LightSaber extends SWEntity implements ForceAbilityRequirement{
	private final int LIGHTSABER_FORCE_ABILITY_REQUIREMENT = 2;
	...
	/**
	 * The Force Ability level required to wield a Lightsaber is 2
	 */
	public int getForceAbilityRequirement() {
		// TODO Auto-generated method stub
		return LIGHTSABER_FORCE_ABILITY_REQUIREMENT;
	}
