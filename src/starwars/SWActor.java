...
public abstract class SWActor extends Actor<SWActionInterface> implements SWEntityInterface {
	...
	/* Setting this to 'protected' is perhaps not the best choice, but it's what SWEntity uses. */
	
	/**The Force Ability of this actor. Defaults to zero.*/
	...
	/**
	 *  Assigns this <code>SWActor</code>'s <code>DroidCarried</code> to 
	 * a own <code>target</code>
	 * <p>
	 * This method will set Droid to <code>SWActor</code> with the <code>target</code>.
	 * A null <code>target</code> would signify that this <code>SWActor</code> does not have a droid.
	 * 
	 * @param 	target the new droid to be set as droid carried
	 * 
	 */
	...
	/**
	 * Returns the droid carried by this <code>SWActor</code>. 
	 * <p>
	 * This method only returns the reference of the droid carried 
	 * and does not remove the droid owned by <code>SWActor</code>.
	 * <p>
	 * If this <code>SWActor</code> does not have a droid this method will return null.
	 * 
	 * @return 	the droid carried by this <code>SWActor</code> or null if no droid is ownedby this <code>SWActor</code>
	 *
	 */
	...
	/**
	 * Check if the droid carries has an owner
	 * By using the method getDroidCarried that return null if <code>SWActor</code> 
	 * does not own a droid
	 * @return false if DroidCarried does not have an owner and true if Droidcarried has an owner
	 */
	public boolean DroidOwn() {
	...
	/**
	 * Get the Force ability level of this <code>SWActor</code>.
	 * @return the force ability level.
	 */
	...
	/**
	 * Set the Force ability level of this <code>SWActor</code>.
	 */
