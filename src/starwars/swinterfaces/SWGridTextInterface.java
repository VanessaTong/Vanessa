...
public class SWGridTextInterface implements GridRenderer {
	 ...
	 * 
	 * @param 	world the world to display grids from
	 ...
	 */
	private static String getLocationString(SWLocation loc) {
	...
	/**
	 * Return the string representation of a <code>SWGrid</code>, made up of <code>getLocationString</code> for
	 * the <code>SWLocation</code>s in the grid.
	 * 
	 * @param grid for which the string is required
	 * @return the grid string, suitable for display purposes
	 */
	private static String getGridString(SWGrid grid) {
		String buffer = "\n";
	...
	/**
	 * Displays the map. The map consists of the grids of the world, in the order 
	 * returned by <code>world.getGrids()</code>.
	 */
	@Override
	public void displayMap() {
		...
		String buffer = "";
		for (SWGrid grid : world.getGrids()) {
			buffer += getGridString(grid);
		}	
		System.out.println(buffer); //print the grids on the screen
